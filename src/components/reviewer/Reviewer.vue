      ...
      <q-card class="my-card">
        <q-form class="q-gutter-md">
          ...
          <div class="q-pa-md" align="center">
            <q-btn color="primary" label="Confirm" @click="updateReviewer" />
          </div>
        </q-form>
      </q-card>
    </div>
  ...
  methods: {
    ...
    setFormData() {
      ...
      this.formData = {
        ...
        is_active: this.reviewer.is_active,
        ...
        faculty: this.reviewer.profile.faculty,
        themes: this.reviewer.profile.themes.map((theme) => theme.theme),
      };
    },
  },
